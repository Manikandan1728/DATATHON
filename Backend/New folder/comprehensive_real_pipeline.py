...
class ComprehensiveRealPipeline:
    """
    Comprehensive pipeline that provides both component comparison AND full competitive intelligence insights.
    """
    ...
    def __init__(self):
        ...
        logger.info("Comprehensive real pipeline initialized")
    ...
    def run_comprehensive_analysis(self) -> Dict[str, Any]:
        ...
        try:
            ...
            comparison_tables = self._create_component_comparison_tables(real_data, component_analysis)
            
            # Step 5: Component Winners Analysis
            print(f"\n[STEP 5] COMPONENT WINNERS ANALYSIS")
            print("-" * 50)
            
            component_winners = self._analyze_component_winners(real_data, component_analysis)
            
            # Step 6: Head-to-Head Component Battles
            print(f"\n[STEP 6] HEAD-TO-HEAD COMPONENT BATTLES")
            print("-" * 50)
            
            head_to_head = self._generate_head_to_head_comparisons(real_data, component_analysis)
    ...
    def _create_component_comparison_tables(self, real_data: Dict[str, Any], component_analysis: Dict[str, Any]) -> Dict[str, Any]:
            ...
            for product_name, product_data in products.items():
                ...
                for component in all_components:
                    if component in product_data:
                        ...
                        component_rating = self._get_component_rating(real_data[category][product_name], component)
    ...
    def _analyze_component_winners(self, real_data: Dict[str, Any], component_analysis: Dict[str, Any]) -> Dict[str, Any]:
        ...
        for category, products in component_analysis.items():
            ...
            for component in products:
                ...
                for product_name in products:
                    product_info = real_data[category][product_name]
    ...
    def _generate_head_to_head_comparisons(self, real_data: Dict[str, Any], component_analysis: Dict[str, Any]) -> Dict[str, Any]:
        ...
        for category, products in component_analysis.items():
            ...
            if len(product_list) >= 2:
                ...
                for component in sorted(all_components):
                    p1_rating = self._get_component_rating(real_data[category][product1], component)
                    p2_rating = self._get_component_rating(real_data[category][product2], component)
...
def main():
    ...
    try:
        pipeline = ComprehensiveRealPipeline()
