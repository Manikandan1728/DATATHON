...
class SimplePipeline:
    """
    Simplified pipeline that works around encoding issues.
    """
    ...
    def run_pipeline(self) -> Dict[str, Any]:
        """
        Run the complete pipeline without emoji issues.
        ...
        try:
            # Step 1: Extract components (using existing category_products.json)
            self._step_extract_components()
            
            # Step 2: Run sentiment analysis
            self._step_sentiment_analysis()
            
            # Step 3: Generate competitor comparison
            self._step_competitor_analysis()
            
            # Step 4: Identify review issues
            self._step_review_intelligence()
            
            # Step 5: Generate strategy suggestions
            self._step_strategy_engine()
            
            # Step 6: Produce executive report
            self._step_executive_report()
    ...
    def _step_extract_components(self):
        ...
        try:
            ...
            print(f"   Input: category_products.json")
    ...
    def _step_competitor_analysis(self):
        """Step 3: Generate competitor comparison."""
    ...
    def _step_review_intelligence(self):
        """Step 4: Identify review issues."""
    ...
    def _step_strategy_engine(self):
        """Step 5: Generate strategy suggestions."""
    ...
    def _step_executive_report(self):
        """Step 6: Produce executive report."""
