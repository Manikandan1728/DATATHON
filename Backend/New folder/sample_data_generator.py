...
class SampleDataGenerator:
    ...
    def __init__(self):
        ...
        self.products = {
            'headphones': {
                'Sony': ['WH-1000XM4', 'WH-1000XM3', 'WF-1000XM4'],
                'Bose': ['QuietComfort 45', 'QuietComfort 35 II', 'SoundSport'],
                'Apple': ['AirPods Pro', 'AirPods Max', 'AirPods 3'],
                'JBL': ['Tune 750BTNC', 'Live 650BTNC', 'Reflect Flow Pro'],
                'Sennheiser': ['MOMENTUM 4', 'HD 660S', 'CX 400BT']
            },
            'smartphones': {
                'Apple': ['iPhone 14 Pro', 'iPhone 14', 'iPhone 13'],
                'Samsung': ['Galaxy S23 Ultra', 'Galaxy S23', 'Galaxy Z Fold 4'],
                'Google': ['Pixel 7 Pro', 'Pixel 7', 'Pixel 6a'],
                'OnePlus': ['OnePlus 11', 'OnePlus 10 Pro', 'OnePlus Nord 2'],
                'Xiaomi': ['Mi 13', 'Redmi Note 12', 'Poco F5']
            },
            'laptops': {
                'Dell': ['XPS 15', 'Inspiron 14', 'Latitude 7420'],
                'HP': ['Spectre x360', 'Envy 13', 'Pavilion 15'],
                'Apple': ['MacBook Pro 16', 'MacBook Air M2', 'MacBook Pro 14'],
                'Lenovo': ['ThinkPad X1 Carbon', 'Yoga 7i', 'Legion 5'],
                'ASUS': ['ZenBook Pro', 'Vivobook 15', 'ROG Strix']
            }
        }
    ...
    def generate_sample_reviews(self, num_reviews: int = 1000) -> Dict[str, Any]:
        ...
        for category in reviews.keys():
            brands = self.brands[category.lower()]
            
            for brand in brands:
                products = self.products[category.lower()][brand]
                
                for product in products:
                    product_reviews = []
                    
                    for _ in range(num_reviews // (len(brands) * len(products))):
                        ...
                        # Convert rating to sentiment (-1 to 1)
    ...
    def save_sample_data(self):
        ...
        sample_reviews = self.generate_sample_reviews(500)
            ...
            for product, components in products.items():
                ...
                for component, reviews in components.items():
                    if reviews:
                        ...
                        sentiments = [r.get('sentiment', 0) for r in reviews if 'sentiment' in r]
                        if sentiments:
